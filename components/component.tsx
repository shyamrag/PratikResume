...
export function Component() {
  ...
  return (
    <div key="1" className="w-full min-h-screen bg-gray-900 text-white">
      <header className="bg-opacity-50 backdrop-blur-sm py-4 sticky top-0 z-50 bg-gray-800">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 flex items-center justify-between">
          <a className="text-xl font-semibold text-white hover:text-gray-300 transition-colors" href="#">
            Pratik Dhamale
          </a>
          <nav className="hidden md:flex items-center space-x-6">
            <a className="hover:text-gray-300 transition-colors font-medium" href="#">Home</a>
            <a className="hover:text-gray-300 transition-colors font-medium" href="#contact">Contact</a>
          </nav>
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-8">
              <div className="md:w-3/5">
                ...
                <p className="mb-6 text-lg leading-relaxed">
                  I am a dedicated and proactive BBA graduate, currently pursuing a Master&apos;s in Supply Chain Logistics from Technological University Dublin. 
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-6 py-4">
                        Sulitest is a valuable tool that is used for raising awareness about the environmental issues across the globe. It empowers academic individuals to make well-informed decisions and inspires them to actively contribute to global sustainability efforts. Prior to this assessment, I was and nervous about my limited knowledge on sustainability and global environmental issues and was curious on what I may discover during the assessment. The assessment introduced me to various facets of sustainability, mainly about social, environmental, and economic features. I learnt about social equality, circular economy, critical raw materials, sustainable consumption and production, natural and industrial ecosystems, profound impacts of climate change, the significance of recycling and reducing waste and adopting repair and remanufacturing processes.
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4">
                        Overall, Sulitest assessment proved to be an eye opener for me on my ability to understand about the global issues the importance of sustainability. This also educated me on how we can meet our current needs without having to overuse the resources and compromise the ability of the future generations to meet their own needs, with the help of sustainable development. It has helped me to realise and reevaluate my day-to-day actions and behaviour as an individual, inspiring to embrace sustainable practices in all aspects of my life.
                      </td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 font-semibold">Plan</td>
                      <td className="px-6 py-4">
                        Going forward, I shall be using ecofriendly and bio-degradable products as these are sustainable and beneficial for our eco system. I will be focusing on reducing waste and think about reusing and recycling products wherever possible. Also, as a future Supply Chain and Logistic professional, I would want to work with organisations that adopt sustainability policies. Additionally, I plan to keep learning and stay up to date on the upcoming issues regarding sustainability and seek clarity on sustainability principles.
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<section id="contact" className="mt-12 md:mt-16 lg:mt-24 bg-gray-800 bg-opacity-90 backdrop-blur-lg rounded-lg p-6 md:p-8 lg:p-10 shadow-lg">
  <div className="flex flex-col md:flex-row gap-8">
    <div className="md:w-1/2 p-6 bg-gray-800 text-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold mb-6">Contact Information</h2>
      <div className="space-y-4">
        <p><strong>Email:</strong> pratikdhamale007@gmail.com</p>
        <p><strong>Phone:</strong> +353 89 468 1149</p>
        <p><strong>Address:</strong> Apt 4, The Oak, Rathvoy Park, John Devoy Road</p>
      </div>
    </div>
    <div className="md:w-1/2 p-6 bg-white text-gray-800 rounded-lg shadow-lg">
      ...
      <form className="space-y-6">
        ...
        <div>
          ...
          <textarea id="message" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" rows={5}></textarea>
        </div>
        <div>
          <button type="submit" className="w-full bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-colors">Send Message</button>
        </div>
      </form>
    </div>
  </div>
